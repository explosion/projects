...
def main(root: Path = typer.Argument(Path.cwd(), help="Root path of repo")):
    """
    Automatically update all auto-generated docs in the repo. If existing
    auto-generated docs are foumd, only that section is replaced. README.md
    ...
    for path in root.glob("**/*/project.yml"):
        path = path.parent
